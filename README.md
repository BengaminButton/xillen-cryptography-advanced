# xillen-cryptography-advanced

AES-256, ключи, Base64, безопасное хранение (Java).
...
## Установка
- Клонируйте репозиторий: git clone https://github.com/BengaminButton/xillen-cryptography-advanced.git
- Перейдите в каталог: cd xillen-cryptography-advanced
